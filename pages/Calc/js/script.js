...
function test(){
    ...
    let yearSelectedCPI;
    let yearWantedCPI;
    let valueYearWanted = document.getElementById("yearWanted").options[yearWanted.selectedIndex].text;
    console.log(valueYearWanted);
    let valueYearSelected = document.getElementById("yearSelected").options[yearSelected.selectedIndex].text;
    console.log(valueYearSelected);
    let inputAmount = document.getElementById("rands").value; 
    console.log(inputAmount);


    switch(true){
        case (valueYearWanted==1920):
            yearWantedCPI = 0.5865;
            break;

        case (valueYearWanted==1921):
            yearWantedCPI = 0.5865;
            break;
    ...
    calcnum = calcNewValue(yearSelectedCPI,yearWantedCPI,inputAmount);
    console.log(calcnum);
    document.getElementById("curValue").value = calcnum.toFixed(2); 
    return calcnum; 
}
